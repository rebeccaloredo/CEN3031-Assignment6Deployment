  ...
  function($scope, $location, $stateParams, $state, Listings){
    ...
    $scope.update = function(isValid) {
       ...
       */
        ...
        Listings.update(id, listing)
                .then(function(response) {
                  $state.go('listings.list', {successMessage: 'Listing has been updated!' });
                }, function(error) {
                    $scope.error = 'Error updating listing!\n' + error;
              });
    };
    ...
    $scope.remove = function() {
      ...
      Listings.delete($stateParams.listingId)
              .then(function(response) {
                $state.go('listings.list', {successMessage: 'Listing has been deleted!' });
              }, function(error) {
                $scope.error = 'Error deleting listing!\n' + error;
              });
